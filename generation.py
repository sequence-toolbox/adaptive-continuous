...
class BarretKokAAdaptive(BarretKokA):
    ...
    def __init__(self, owner: QuantumRouterAdaptive, name: str, middle: str, other: str, memory: Memory, from_app_request: bool):
...
class SingleHeraldedAAdaptive(SingleHeraldedA):
    ...
    def __init__(self, owner: QuantumRouterAdaptive, name: str, middle: str, other: str, memory: Memory, from_app_request: bool, raw_epr_errors: list[float]):
        """Constructor for entanglement generation A class.
